...
contract ProtocolDataProvider {
  ...
  function getAllAssetTokens() external view returns (TokenData[] memory) {
  ...
  function getDefaultReserveInterestRateStrategy(address asset)
    external
    view
    returns (
    ...
    )
  {
    ...
    return (
      ...
      interestRateStrategy.EXCESS_UTILIZATION_RATE(),
      interestRateStrategy.baseVariableBorrowRate(),
  ...
  function getReserveTokenAddresses(address asset)
    external
    view
    returns (
