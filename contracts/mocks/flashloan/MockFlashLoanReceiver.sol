...
contract MockFlashLoanReceiver is FlashLoanReceiverBase {
  ...
  IAddressProvider internal _provider;
  ...
  constructor(IAddressProvider provider) public FlashLoanReceiverBase(provider) {}
  ...
  function executeOperation(
    ...
    for (uint256 i = 0; i < assets.length; i++) {
      ...
      MockMintableERC20 token = MockMintableERC20(assets[i]);
