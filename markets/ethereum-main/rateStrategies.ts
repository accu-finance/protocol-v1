...
// AAVE
export const rateStrategyAAVE: InterestRateStrategyConfig = {
  name: InterestRateStrategyName.rateStrategyACCRUE,
  optimalUtilizationRate: utils.parseUnits('0.45', RAY_DECIMALS),
  baseVariableBorrowRate: Zero,
  variableRateSlope1: Zero,
  variableRateSlope2: Zero,
  stableRateSlope1: Zero,
  stableRateSlope2: Zero,
};
...
// SNX
export const rateStrategyVolatileThree: InterestRateStrategyConfig = {
  name: InterestRateStrategyName.rateStrategyVolatileThree,
  optimalUtilizationRate: utils.parseUnits('0.65', RAY_DECIMALS),
  baseVariableBorrowRate: Zero,
  variableRateSlope1: utils.parseUnits('0.08', RAY_DECIMALS),
  variableRateSlope2: utils.parseUnits('3', RAY_DECIMALS),
...
export const rateStrategyVolatileFour: InterestRateStrategyConfig = {
  name: InterestRateStrategyName.rateStrategyVolatileFour,
  optimalUtilizationRate: utils.parseUnits('0.45', RAY_DECIMALS),
  baseVariableBorrowRate: Zero,
  variableRateSlope1: utils.parseUnits('0.07', RAY_DECIMALS),
  variableRateSlope2: utils.parseUnits('3', RAY_DECIMALS),
